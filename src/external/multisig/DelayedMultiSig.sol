 ...
 */
contract DelayedMultiSig is MultiSig {
  // ============ Events ============
    ...
    pastTimeLock(transactionId)
  {
    ...
    txn.executed = true;
    bool success = externalCall(txn.destination, txn.value, txn.data.length, txn.data);
   ...
   */
  function executeMultipleTransactions(uint256[] memory transactionIds)
    public
    ownerExists(msg.sender)
  {
   ...
   */
  function setConfirmationTime(uint256 transactionId, uint256 confirmationTime) internal {
